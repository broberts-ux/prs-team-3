...
function Header() {
  ...
  const roles = [user?.isReviewer && "Reviewer", user?.isAdmin && "Admin"].filter(Boolean).join(" · ");
        ...
        <div className="container-fluid">
          ...
          {user ? (
            <Dropdown className="me-4">
              <Dropdown.Toggle as="a" variant="light" className="d-flex text-secondary align-items-center link-body-emphasis text-decoration-none">
                ...
                <div className="d-flex flex-column text-start">
                  ...
                  {roles && <span className="small text-secondary">{roles}</span>}
                </div>
              </Dropdown.Toggle>
              <Dropdown.Menu>
            ...
            <Link to={`/signin`} className="btn btn-primary">
              <svg className="bi pe-none me-2" width={24} height={24} fill="#FFFFFF">
